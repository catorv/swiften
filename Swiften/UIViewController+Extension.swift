...
extension UIViewController {
  ...
  public static func show(viewController controller: UIViewController, animated: Bool = true) {
  ...
  public func show(animated: Bool = true) {
    UIViewController.show(viewController: self, animated: animated)
  }
...
extension UIViewController {
  ...
  var navigationBarAlpha: CGFloat {
    ...
    set {
      self.setNavigationBarAlpha(newValue, animated: false)
    }
  }
...
extension UIViewController {
  ...
  public static func viewController(withIdentifier id: String, storyboardName name: String, bundle: Bundle? = nil) -> UIViewController {
