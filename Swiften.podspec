#
#  Be sure to run `pod spec lint Swiften.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Cator V" => "hi@catorv.com" }
  # Or just: s.author    = "Cator V"
  # s.authors            = { "Cator V" => "hi@catorv.com" }
  # s.social_media_url   = "http://twitter.com/Cator V"
  ...
  s.source       = { :git => "https://github.com/catorv/swiften", :tag => "#{s.version}" }
